...
void sci_insErrorDynamics(scicos_block *block, scicos::enumScicosFlags flag)
{
    ...
    if (flag==scicos::computeOutput)
    {
        ...
        { 
            ...
            #include "arkmath/gen/navigation/ins_error_dynamics_F.hpp"
            #include "arkmath/gen/navigation/ins_error_dynamics_G.hpp"
        }
        ...
        { 
            ...
            #define F_att F
            #define G_att F
            #include "arkmath/gen/navigation/ins_error_dynamics_F_att.hpp"
            #include "arkmath/gen/navigation/ins_error_dynamics_G_att.hpp"
        }
        ...
        { 
            ...
            #define F_vp F
            #define G_vp G
            #include "arkmath/gen/navigation/ins_error_dynamics_F_vp.hpp"
            #include "arkmath/gen/navigation/ins_error_dynamics_G_vp.hpp"
        }
        else
        {
